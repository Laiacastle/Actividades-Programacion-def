...
/*namespace Activitats2
{
    ...
    {
        public static int ToIntegrerL(decimal num)
        {
            return (int)num;
        }
        public static decimal ToDecimalL(decimal num)
        {
            return num - ToIntegrerL(num);
        }
        public static void Main()
        {
            ...
            try
            {
                ...
                Console.WriteLine(MsgEnd, ToDecimalL(num), ToIntegrerL(num));
            }
